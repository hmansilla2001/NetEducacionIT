...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <asp:GridView ID="gridRubroDataList" runat="server" OnRowDataBound="gridRubroDataList_RowDataBound" CellPadding="4" ForeColor="#33333" GridLines="Both" AutoGenerateColumns="false">
        <AlternatingRowStyle BackColor = "White" ForeColor="#284775"/>
        <Columns>
            <asp:BoundField DataField="IdRubro" HeaderText="Codigo"/>
            <asp:BoundField DataField="DescripcionRubro" HeaderText="Descripcion"/>
        </Columns>
